    ...
    <>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 sm:py-36">
          <div className="text-center">
            ...
            <p className="mt-8 mx-auto max-w-2xl text-lg text-foreground-muted leading-relaxed">
              데이터, AI, 클라우드 기술을 결합하여 비즈니스의 잠재력을
              실현합니다.
            ...
            <div className="mt-16 pt-10 border-t border-border">
              <p className="text-xs text-foreground-muted/60 uppercase tracking-wider mb-4">
                운영 중인 서비스
              </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-foreground-muted">
            D-ALabs의 다양한 영역을 살펴보세요
          </p>
        </div>

        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <NavCard title="About" desc="철학, 비전, 그리고 미션" href="/about" />
          <NavCard
            title="Services"
            desc="디지털 연금술 프로덕트와 솔루션"
            href="/services"
          />
          <NavCard title="News" desc="최신 업데이트와 소식" href="/news" />
          <NavCard
            title="Community"
            desc="커뮤니티와 함께 성장"
            href="/community"
          />
          <NavCard title="Support" desc="고객 지원 및 문의" href="/support" />
          <NavCard
            title="Sign Up"
            desc="플랫폼에 가입하고 시작하기"
            href="/signup"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span
          className={`text-lg font-semibold ${highlight ? "text-primary" : "text-foreground"} group-hover:text-primary transition-colors`}
        >
          {title}
        </span>
        <svg
          className="w-4 h-4 text-foreground-muted group-hover:text-primary group-hover:translate-x-1 transition-all"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
...
function LembicIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
      <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14l-5-5 1.41-1.41L11 13.17l4.59-4.58L17 10l-6 6z" />
    </svg>
  );
}
